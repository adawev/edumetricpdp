...
export const Icons = {
  ...
  download:   (p: P) => <Svg {...p}><path d="M12 3v12m0 0 5-5m-5 5-5-5M5 21h14"/></Svg>,
  upload:     (p: P) => <Svg {...p}><path d="M12 21V9m0 0 5 5m-5-5-5 5M5 3h14"/></Svg>,
  bar:        (p: P) => <Svg {...p}><path d="M3 3v18h18"/><rect x="7" y="10" width="3" height="8"/><rect x="13" y="6" width="3" height="12"/></Svg>,
  users:      (p: P) => <Svg {...p}><circle cx="9" cy="8" r="4"/><path d="M3 21a6 6 0 0 1 12 0"/><circle cx="17" cy="9" r="3"/><path d="M21 21a4 4 0 0 0-6-3.5"/></Svg>,
  plus:       (p: P) => <Svg {...p}><path d="M12 5v14M5 12h14"/></Svg>,
  message:    (p: P) => <Svg {...p}><path d="M21 11.5a8.4 8.4 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.4 8.4 0 0 1-3.8-.9L3 21l1.9-5.7a8.4 8.4 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.4 8.4 0 0 1 3.8-.9h.5a8.5 8.5 0 0 1 8 8z"/></Svg>,
  edit:       (p: P) => <Svg {...p}><path d="M17 3a2.85 2.85 0 0 1 4 4L7.5 20.5 2 22l1.5-5.5z"/></Svg>,
  file:       (p: P) => <Svg {...p}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/></Svg>,
  arrowLeft:  (p: P) => <Svg {...p}><path d="M19 12H5M11 19l-7-7 7-7"/></Svg>,
